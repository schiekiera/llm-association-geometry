...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=str,
        default=None,
        help="Output PDF path. Defaults to output/05_plots/02_prediction/01_held_out_words/ablation_rr_model_performance_grid_2x4.pdf",
    )
    args = ap.parse_args()

    if args.out_pdf is None:
        out_pdf = OUTPUT_DIR / "ablation_rr_model_performance_grid_2x4.pdf"
    else:
